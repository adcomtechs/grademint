...
// import { BaseComponent } from '../../common/BaseComponent.js';
// import { CourseForm } from '../course-form/CourseForm.js';
// import { Semester } from '../../../domain/Semester.js';
// import { createElement, clearElement } from '../../../utils/dom.js';
// import { formatGPA } from '../../../utils/formatters.js';
// import { watchState } from '../../../utils/selector.js';
...
//     /**
//      * The currently active CourseForm instance.
//      * Unmounted and replaced when the active semester changes.
//      * @type {CourseForm|null}
//      */
//     this._activeForm = null;
//   }
...
//   render() {
//     // Always clean up the previous form before re-rendering.
//     // A stale form holds an AbortController and event listeners that would
//     // otherwise survive the clear and target detached DOM nodes.
//     this._activeForm?.unmount();
//     this._activeForm = null;
...
//   /**
//    * Stagger-animates course rows as they enter the viewport.
//    * Prevents all rows firing their animation simultaneously on load.
//    * @param {HTMLElement} root
//    */
//   _observeRows(root) {
//     const io = new IntersectionObserver(
